      ...
      <BrandHeader />
        ...
        {(!mapCenter && appMode === 'map') ? (
          ...
          <div className="flex-1 w-full flex flex-col-reverse md:flex-row min-h-0">
            ...
            {/* Sidebar Quote Panel */}
            <div className="w-full md:w-80 lg:w-96 bg-white border-r md:border-r border-slate-200 shadow-xl z-10 flex flex-col shrink-0 max-h-[30vh] md:max-h-none border-t md:border-t-0">
